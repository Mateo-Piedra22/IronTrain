...
export const SYNC_TABLES: Record<string, TableConfig> = {
    ...
    user_profiles: {
        ...
        bigIntColumns: ['created_at', 'updated_at', 'deleted_at', 'streak_week_evaluated_at', 'score_lifetime'],
        booleanColumns: ['is_moderated', 'is_unreleased'],
        timestampColumns: ['created_at', 'updated_at', 'deleted_at', 'streak_week_evaluated_at'],
    },
    kudos: {
        name: 'kudos',
        requiresOwnership: true,
    ...
    activity_feed: {
        ...
        booleanColumns: ['is_private', 'is_moderated'],
    ...
    activity_seen: {
        ...
        bigIntColumns: ['seen_at', 'updated_at'],
        booleanColumns: [],
        timestampColumns: ['seen_at', 'updated_at'],
    }
};
