    ...
    return (
        <Modal visible={visible} animationType="slide" transparent>
            <KeyboardAvoidingView
                ...
                className="flex-1 bg-iron-950/50 justify-end"
            >
                    ...
                    <ScrollView className="flex-1 p-4">
                        ...
                        <View className="flex-row flex-wrap mb-6">
                            {categories.map(cat => (
                                ...
                                >
                                    <Text className={categoryId === cat.id ? 'text-primary font-bold' : 'text-iron-950'}>
                                        {cat.name}
                                    </Text>
                                </TouchableOpacity>
                            ))}
                        ...
                        <View className="mb-6">
                            {EXERCISE_TYPES.map(t => (
                                ...
                                >
                                    <Text className="text-iron-950 font-semibold">{t.label}</Text>
