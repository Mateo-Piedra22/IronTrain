...
export function TimerOverlay() {
    ...
    return (
        <View className="absolute bottom-24 right-4 bg-iron-800 border border-primary rounded-full flex-row items-center p-2 shadow-xl z-50">
            {/* Time Display */}
            <View className="px-3">
                <Text className="text-iron-950 font-bold text-xl font-mono">{formatTime(timeLeft)}</Text>
            </View>
            ...
            <View className="flex-row items-center border-l border-iron-600 pl-2 gap-2">
                ...
                <TouchableOpacity onPress={stopTimer} className="p-1 bg-primary rounded-full active:opacity-80">
