...
export const createSocialStyles = (colors: any) => StyleSheet.create({
    ...
    compareBarFillUser: {
        height: '100%',
        backgroundColor: withAlpha(colors.primary.DEFAULT, '70'),
        borderRadius: 999,
    },
    compareBarFillFriend: {
        height: '100%',
        backgroundColor: withAlpha(colors.yellow, '70'),
        borderRadius: 999,
    },
    compareValueRow: {
        backgroundColor: colors.surface,
    ...
    modalOverlay: {
        flex: 1,
        backgroundColor: withAlpha(colors.background, '75'),
        justifyContent: 'center',
        alignItems: 'center',
        padding: 20,
    },
    ...
    modalActionBtnCompact: {
        minHeight: 44,
        paddingVertical: 10,
        borderRadius: 12,
    },
    dualActionRowCompact: {
        flexDirection: 'row',
        gap: 8,
        marginTop: 2,
    },
    ...
    friendModalBadgeText: {
        color: colors.text,
        fontSize: 11,
        fontWeight: '800',
        textTransform: 'uppercase',
    },
    friendModalMetricsGrid: {
        flexDirection: 'row',
        flexWrap: 'wrap',
        justifyContent: 'space-between',
        gap: 8,
    ...
    infoDivider: {
        height: 1,
        backgroundColor: withAlpha(colors.border, '60'),
        marginVertical: 10,
    },
    ...
    thermalCard: {
        backgroundColor: withAlpha(colors.background, 'F5'),
        borderRadius: 20,
        borderWidth: 1,
        borderColor: withAlpha(colors.border, 'AA'),
        padding: 20,
        marginVertical: 10,
        elevation: 10,
    ...
    thermalSeparator: {
        height: 1,
        backgroundColor: withAlpha(colors.border, '80'),
        marginVertical: 15,
    },
    thermalRow: {
        flexDirection: 'row',
    ...
    thermalBadge: {
        backgroundColor: withAlpha(colors.surfaceLighter, 'C0'),
        paddingHorizontal: 12,
        paddingVertical: 6,
        borderRadius: 6,
        borderWidth: 1,
