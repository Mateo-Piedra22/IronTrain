...
export default function CategoryDetailScreen() {
    ...
    const ss = useMemo(() => StyleSheet.create({
        ...
        addBtn: { width: 40, height: 40, borderRadius: 12, backgroundColor: colors.primary.DEFAULT + '15', borderWidth: 1.5, borderColor: colors.primary.DEFAULT + '30', justifyContent: 'center', alignItems: 'center' },
        ...
        typeChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 10, borderWidth: 1.5, borderColor: colors.iron[300], backgroundColor: colors.iron[200] },
        ...
        exerciseIcon: { width: 40, height: 40, borderRadius: 12, backgroundColor: colors.iron[200], borderWidth: 1.5, borderColor: colors.iron[300], justifyContent: 'center', alignItems: 'center' },
